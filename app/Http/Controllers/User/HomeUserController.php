...
class HomeUserController
{
    ...
    {
        $products = Product::getActiveProducts()->paginate(8); // mỗi trang 8 sp
    ...
    {
        $product = Product::getProductWithRelationsById($id); // Lấy sản phẩm theo ID và bao gồm các quan hệ cần thiết
    ...
    public function product(Request $request)
    {
        ...
        $products = $productsQuery->orderBy('id', 'desc')->paginate(12)->withQueryString();
